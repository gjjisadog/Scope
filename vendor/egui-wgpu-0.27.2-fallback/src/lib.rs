...
pub struct WgpuConfiguration {
    ...
    /// Request a fallback/software adapter when possible.
    ///
    /// On Windows this allows the app to use the DX12 WARP adapter as a last
    /// resort for virtual desktops without a usable GPU.
